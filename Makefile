# This Makefile is for the Exporter extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Exporter.pm]
#     INSTALLDIRS => q[perl]
#     LICENSE => q[perl]
#     NAME => q[Exporter]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Exporter.pm]
...
TO_INST_PM = lib/Exporter.pm \
	lib/Exporter/Heavy.pm

PM_TO_BLIB = lib/Exporter/Heavy.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Exporter/Heavy.pm $(INST_MAN3DIR)/Exporter::Heavy.$(MAN3EXT) \
	  lib/Exporter.pm $(INST_MAN3DIR)/Exporter.$(MAN3EXT) 
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Exporter/Heavy.pm blib/lib/Exporter/Heavy.pm \
	  lib/Exporter.pm blib/lib/Exporter.pm 
